...
QA: independent market breadth/median checks, sector RS equivalence, at least 3 samples per role with raw member inputs and direct recalculations, same-type percentile checks. Tests 16 passed,0 failed. See audit JSON and SECTOR_SAMPLE_CALC.md.
