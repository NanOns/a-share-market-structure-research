...
5. BaoStock SDK `0.9.4` is installed in the runtime. The downloaded wheel SHA-256 is `0bf71c6069ab5890ff3596632f9c3f8f1fbc6bfcac582c2f9d6a5c11ab2cfa8f`. The inspected SDK exposes `set_API_key()` and routes `bs-` API keys to `vip-api.baostock.com`; this verifies SDK wiring, not the supplied account's live credentials.
