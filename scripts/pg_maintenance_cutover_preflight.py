...
REQUIRED_REPORTS = {
    ...
    "backup_service_catalog": "pg_backup_service_catalog_rehearsal_report.json",
    "storage_governance": "pg_storage_governance_rehearsal_report.json",
    "incremental_writer_repository": "pg_incremental_writer_repository_rehearsal_report.json",
    "research_builder_repository": "pg_research_builder_repository_rehearsal_report.json",
    "cutover_completion": "pg_application_cutover_completion.json",
}
