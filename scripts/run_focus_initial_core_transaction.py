"""Initial Focus core transaction with explicit commit or rollback rehearsal."""
        ...
        try:
            ...
            with con.cursor() as cur:
                ...
                for item in observations:
                    ...
                    insert_episode_facts(cur, episode_id=episode, row=row)
