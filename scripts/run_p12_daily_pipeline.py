...
def main():
 ...
 if active and enriched and active.get('contract_id')=='TODAY_RESEARCH_BUNDLE_V3_3_CANDIDATE_02' and active['identity'].get('publication_id')==args.publication_id and active['identity'].get('trade_date')==args.trade_date:
