...
"""Seal Required Scope completion while keeping optional BSE isolation explicit."""
...
def main() -> int:
    ...
    receipt = {
        ...
        "next_stage": "V4_01_EXTERNAL_ONLINE_MODEL_ACCEPTANCE" if not blockers else "V4_01_REMEDIATE_R6_BLOCKERS",
    }
